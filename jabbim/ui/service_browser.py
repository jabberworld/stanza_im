...
class ServiceBrowserDialog(QtWidgets.QDialog):
    ...
    def _register(self) -> None:
        ...
        if not data or not data.get("jid"):
            return
        from jabbim.ui.registration_dialog import RegistrationDialog
    ...
    def _search(self) -> None:
        ...
        if not data or not data.get("jid"):
            return
        from jabbim.ui.search_dialog import SearchDialog
    ...
    def _commands(self) -> None:
        ...
        if not data or not data.get("jid"):
            return
        from jabbim.ui.adhoc_dialog import AdhocDialog
